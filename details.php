							...
							<div id="mycarousel" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									...
									<div class="item active">
										<center>
											<img src="<?php echo $p_img1 ?>" class="img-responsive">
										</center>
									</div>

									<div class="item">
										<center>
											<img src="<?php echo $p_img2 ?>" class="img-responsive">
										</center>
									</div>

									<div class="item">
										<center>
											<img src="<?php echo $p_img3 ?>" class="img-responsive">
										</center>
									</div>
								</div>
								<!--carousel-inner start-->
		...
		<div class="col-md-7">
			<select name="product_size" class="form-control">
				...
				<div class="box" id="display_review">
					<div class="row">
						<div class="col-md-5" style="padding-top: 50%; transform: translate(0%, -50%);">
							<h1 align="center"><b>
									<?php echo round($AVGRATE, 1); ?>
								</b> <i class="fa fa-star" data-rating="2" style="font-size:32px;color:#ffc300;"></i>
							</h1>
							<p align="center">
								<?= $Total; ?> ratings and <?= $TotalReviews; ?> reviews
							</p>
						</div>
						<div class="col-md-7">
							<?php
	                while ($db_review = mysqli_fetch_array($review)) {
		                ...
		                if ($db_review['rating'] == 5) {
								...
								<?php?>
								by <span style="font-size:14px;"><b>
										<?= $db_review['name']; ?>
									</b></span>
							</h4>
							<p>
				...
				<div class="box" id="give_review">
					...
					<form id="ratingForm" method="POST" action="review.php">
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="5" placeholder="Write your product review here..."
								name="review" id="review" required></textarea><br>
							<button class="btn btn-default btn-sm btn-info" id="review_btn" type="submit" type="button"
								style="margin-left: 50%; transform: translate(0%, -50%);">Submit</button>
						</div>
					</form>
				</div>
				<?php } else { ?>
				<div class="box" id="give_review">
				<?php echo "Please login to add a review"; } ?>
				</div>

...
store_visited_pages("Contact Us");
?>
...
// $receiverEmail="yogesh.luckshetty@gmail.com"; //admin mail
// $retval = mail($receiverEmail,$senderSubject,$senderMessage,$senderEmail);
//Customer mail
// $email=$_POST['email'];
...
// $from="yogesh.luckshetty@gmail.com";
// $retval = mail($email,$subject,$msg,$from);
// if( $retval == true ) {
...
$insert_feedback="insert into customer_feedback (name,email,title,message) values('$senderName','$senderEmail','$senderSubject','$senderMessage')";
$run_customer=mysqli_query($con,$insert_feedback);
echo "<script>alert('Your messsage has been successfully sent to the admin, you will be redirected to the home page.')</script>";

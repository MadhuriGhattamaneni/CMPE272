...
$db=mysqli_connect("localhost", "root", "", "cmpe_final");
// $db=mysqli_connect("localhost", "id19993608_root", "Password@123", "id19993608_cmpe_final");
...
function addCart(){
	...
	if(isset($_GET['add_cart'])){
		$ip_add=getUserIP();
		$p_id=$_GET['add_cart']; //this is the product id
...
function getPro(){
	...
	while ($row_product=mysqli_fetch_array($run_products)) {
		...
		<img src='$pro_img1' class='img-responsive'>
...
function getPcatPro(){
	...
	if (isset($_GET['p_cat'])) {
		...
		if($count==0){
			echo "
			<div class='box'>
			<h1>Currently, there are no products under this category</h1>
			</div>
